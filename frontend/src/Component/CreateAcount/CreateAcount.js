    ...
    return (
        <div className='CenteredContainer'>
            <div className="ContainerCreateAcount" >
                ...
                <form onSubmit={handleSubmit} className='Username_Email_Password_ConfirmPassword_Country' >
                    ...
                    <input type="password" className="ConfirmPasswordCreateAcount" name="confirm_password" placeholder="confirm password" onChange={(e) => setConfirmPassword(e.target.value)} required />

                    <label className='labelInputCreateAcount' htmlFor="country">Country</label>
                    <select className='allCountryCreateAcount' id="country" name="country" defaultValue="" onChange={(e) => setCountry(e.target.value)} required>
